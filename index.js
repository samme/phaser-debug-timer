...
(function() {
  var COLOR_EXPIRED, COLOR_OTHER, COLOR_PAUSED, COLOR_PENDING_DELETE, COLOR_RUNNING, Phaser, SECOND, _rect, timerColor;
  ...
  Phaser.Utils.Debug.prototype.timerElapsed = function(timer, x, y, label) {
    ...
    this.text((label ? label + ": " : "") + (seconds < 1 ? ms + "ms" : (~~seconds) + "s"), x, y, timerColor(timer), this.font);
  };
